    ...
    <div class="col-lg-11 py-5">
      <div class="row">
        <div class="col-lg-6 ps-5">
          <h1 class=" mt-3 text-white">WELCOME IN THE WORLD OF ASTRONOMY</h1>
          <p class="my-3 fs-3 text-white">Here You Will Learn All ABout Space</p>
        </div>
        <div class="col-lg-5">
      ...
      <div class="col-sm-4">
        <div class="card my-2">
          ...
          <div class="card-body">
            ...
            <a href="pdf_view.php" class="btn btn-primary read">Read More...</a>
          </div>
        </div>
      </div>
      <?php
